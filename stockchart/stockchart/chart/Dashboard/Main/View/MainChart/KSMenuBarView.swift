...
class KSMenuBarView: KSBaseView {
    ...
    override func createChildViews() {
        let orderbookText        = String.ks_localizde("ks_app_global_text_orderbook") //Book
        let marketTradeText      = String.ks_localizde("ks_app_global_text_market_trade") //Market Trade
        let infoText             = String.ks_localizde("ks_app_global_text_info") //Info
